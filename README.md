...
Type guard for detecting if given action is generated by the class.
The detected type will be union of actions the class generates.

Example

```ts
if (isActionFrom(someAction, MyImmerReducer)) {
